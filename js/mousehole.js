...
function setup() {
    ...
    holeMice.push(new zMouse(width * .12, height * .2));
    holeMice.push(new zMouse(width * .3, height * .5));
    holeMice.push(new zMouse(width * .8, height * .4));
    holeMice.push(new zMouse(width * .6, height * .13));
...
//# sourceMappingURL=mousehole.js.map